...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "Celerium.Auvik\docs"
        NO  - "Celerium.Auvik\Celerium.Auvik\docs"

    Example: "C:\Celerium\Projects\Celerium.Auvik\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "Celerium.Auvik\docs"
    Reference:
        Yes - "Celerium.Auvik\docs\Endpoints.csv"
        NO  - "Celerium.Auvik\Celerium.Auvik\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\Celerium.Auvik\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/Celerium.Auvik"
