<#
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSetting\Initialize-AuvikModuleSetting.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSetting\Initialize-AuvikModuleSetting.Tests.ps1 -Output Detailed
