...
The "Celerium.Auvik" team and community take all security bugs in "Celerium.Auvik" seriously. Thank you for improving the security of "Celerium.Auvik". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "Celerium.Auvik" will confirm the problem and determine the affected versions.
- "Celerium.Auvik" will audit code to find any potential similar problems.
- "Celerium.Auvik" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
